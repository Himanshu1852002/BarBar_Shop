        ...
        <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="container mx-auto md:px-0 px-20 lg:px-20 py-5 md:py-0 flex flex-col-reverse md:flex-row-reverse items-center justify-between gap-10 text-white">
                ...
                <div className="max-w-xl text-center md:text-left">
                    <h1 className="text-4xl md:text-5xl font-extrabold uppercase leading-tight tracking-wider">
                        Unleash Your
                    </h1>
                    <h1 className="text-4xl md:text-5xl font-extrabold uppercase leading-tight tracking-wider">
                    ...
                    <button className="mt-6 cursor-pointer bg-[#cf814d] text-text font-semibold py-2 px-6  hover:shadow-[0_0_25px_#cf814d] transition duration-400 tracking-wider">
                        BOOK NOW
                    </button>
                </div>
            </div>
